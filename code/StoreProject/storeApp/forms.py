...
class ProductForm(forms.Form):
	productID = forms.CharField(label='Username',min_length=6, max_length=100, required=True)
	productName = forms.CharField(label='FirstName', min_length=1, max_length=100, required=True)
	productDescription = forms.CharField(label='LastName', min_length=1, max_length=100, required=True)
