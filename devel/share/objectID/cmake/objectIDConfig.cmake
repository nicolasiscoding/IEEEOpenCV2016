...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'objectID' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nicolas/objectRecognition_ws/src/objectID/${idir}'.  Ask the maintainer 'nicolas <nicolas@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nicolas/objectRecognition_ws/devel/lib;/home/nicolas/objectRecognition_ws/devel/lib;/opt/ros/indigo/lib)
